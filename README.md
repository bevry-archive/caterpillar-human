...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/caterpillar-human/^6.11.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/caterpillar-human@^6.11.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/caterpillar-human@6.11.0'
</script>
```
