...
<h1>Human Transform for Caterpillar</h1>
...
<span class="badge-travisci"><a href="http://travis-ci.com/bevry/caterpillar-human" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/com/bevry/caterpillar-human/master.svg" alt="Travis CI Build Status" /></a></span>
...
<li>Import: <code>import pkg from ('caterpillar-human')</code></li>
<li>Require: <code>const pkg = require('caterpillar-human').default</code></li>
</ul>
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/caterpillar-human/^6.12.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/caterpillar-human@^6.12.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/caterpillar-human@6.12.0'
</script>
```
